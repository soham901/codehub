...
export default function Navbar() {
  return (
    <>
      <div className="dui-navbar backdrop-blur-3xl rounder-lg   ">
        ...
        <div className="flex-none gap-2">
          <div className="dui-form-control">
            <input
              type="text"
              placeholder="Search"
              className="dui-input dui-input-bordered w-24 md:w-auto mr-5"
            />
          </div>
          <div className="dui-dropdown dui-dropdown-end">
            ...
            >
              <div className="dui-avatar">
                <div className="w-15 dui-mask dui-mask-hexagon">
                  <Image
            ...
            <ul
              tabIndex={0}
              className="dui-menu dui-menu-sm dui-dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52"
            >
              <li>
