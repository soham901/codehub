...
export default function Navbar() {
  ...
  <div className="flex-none gap-2">
    <div className="dui-form-control">
      <input type="text" placeholder="Search" className="dui-input dui-input-bordered w-24 md:w-auto mr-5" />
    </div>
    <div className="dui-dropdown dui-dropdown-end">
      <label tabIndex={0} className="dui-btn dui-btn-ghost dui-btn-circle dui-avatar">
    ...
    />
      ...
      <ul tabIndex={0} className="dui-menu dui-menu-sm dui-dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
        <li>
